...
export function HeadphonesIcon({ className = "size-5" }: { className?: string }) {
  return (
    <svg
      aria-hidden="true"
      className={className}
...
export function ArrowLeftIcon({ className = "size-5" }: { className?: string }) {
  return (
    <svg
      aria-hidden="true"
      className={className}
...
export function FacebookIcon({ className = "size-4" }: { className?: string }) {
  return (
    <svg
      ...
      fill="currentColor"
    >
      <path d="M9.101 23.691v-7.98H6.627v-3.667h2.474v-1.58c0-4.085 1.848-5.978 5.858-5.978.401 0 .955.042 1.468.103a8.68 8.68 0 0 1 1.141.195v3.325a8.623 8.623 0 0 0-.653-.036 26.805 26.805 0 0 0-.733-.009c-.82 0-1.667.245-2.074.654-.407.41-.54 1.168-.54 2.197v1.133h4.316l-.587 3.667h-3.729v7.98A11.968 11.968 0 0 0 24 12c0-6.627-5.373-12-12-12S0 5.373 0 12c0 5.99 4.388 10.954 10.125 11.854v-.163h-1.024z" />
    </svg>
  );
}
